...
public class SplashScreen implements Utils {
    ...
    private static void drawScreen(float width, float height) {
        ...
        fr.drawCenteredString("Pulsar", width / 2f, actualY,
        ...
        if (versionAnim != null) {
            ...
            float versionX = width / 2f + fr.getStringWidth("Pulsar") / 2f - (versionWidth);
        ...
        if (progressAnim == null) {
            ...
            float rectWidth = fr.getStringWidth("Pulsar") + 10;
            float rectHeight = 5;
